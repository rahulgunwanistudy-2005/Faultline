# Phase 3: Posterior and Confidence

## Objective

Implement OCR-candidate marginalization, log-space posterior scoring, evidence records, no-consistent baseline, and confidence gating.
...
- [ ] Exact transcriptions select expected rules.
- [ ] Low OCR confidence refuses diagnosis.
- [ ] Near-tied rules remain ambiguous.
